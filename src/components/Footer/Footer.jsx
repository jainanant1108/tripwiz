...
const Footer = () => {
    ...
    return (
        <div id='footerMainWrapper'>
            <Grid
                container md={12} id="gridMainWrapper"
                    ...
                    <div id='column1OuterWrapper' >
                        ...
                        <div id='column1Row2Wrapper'>
                            <Typography
                                ...
                                marginTop={5}
                            >
                                This is the version of our website addressed to speakers of English in Canada.
                                The application follows the English-US standards.
                            </Typography>
                        </div>
